    ...
    <footer class="ps-footer">
        <div class="ps-container">
                ...
                <aside class="widget widget_footer widget_contact-us">
                    ...
                    <div class="widget_content">
                        ...
                        <p class="mt-10">BrandedStocklots.com is the largest <br />
                            ...
                            With sellers from 90 countries, we offer <br /> a wide range of high quality products
                            <br /> that can uplift your sales.
                        </p>
            ...
            <div class="ps-footer__links">
                <p><strong>Consumer Electrics:</strong><a href="#">Audio Equipment</a><a href="#">Cameras &
                        Photo</a><a href="#">Computer Accessories</a><a href="#">Computer Hardware</a><a
                        href="#">Desktop Computers</a><a href="#">Laptops & Tablets</a><a href="#.html">Printers &
                        Photocopiers</a><a href="#.html">Small Appliances</a><a href="#.html">Video games &
                        consoles</a> <a href="#.html">Multimedia</a> <a href="#.html">Pallets of mixed
                        electronics</a>
                </p>
                <p><strong>Building & Industry:</strong><a href="#">Building & Industrial Machinery</a><a
                        href="#">Building Materials</a><a href="#">Tools</a><a href="#">Redecoration & Renovation
                        products</a><a href="#">Workwear & PPE</a>
                </p>
                <p><strong>Clothing:</strong><a href="#">Baby & Children Clothes</a><a href="#">Bags &
                        Handbags</a><a href="#">Fashion Accessories</a><a href="#">Men's Clothing</a><a
                        href="#">Stocklots Clothing</a><a href="#">Swimwear</a><a href="#">Underwear</a><a
                        href="#.html">Used Clothing</a> <a href="#.html">Women's Clothing</a>
                </p>
                <p><strong>Food & Beverage:</strong><a href="#">Alcohol</a><a href="#">Beverages</a><a href="#">Food
                        Stocks</a><a href="#">Short-dated food</a>
                </p>
                <p><strong>For Children:</strong><a href="#">Nursery Products</a><a href="#">Toys & Games</a>
                </p>
                <p><strong>Health & Beauty:</strong><a href="#">Body Cosmetics</a><a href="#">Cosmetic
                        Accessories</a><a href="#">Facial Cosmetics & Make Up</a><a href="#">Fragrances</a><a
                        href="#">Hair care</a><a href="#">Healthcare Products</a><a href="#">Toiletries</a>
                </p>
                <p><strong>Home, garden & office:</strong><a href="#">Bathware</a><a href="#">Decorations & Seasonal
                        Goods</a><a href="#">Gardening Products</a><a href="#">Household Chemicals</a><a href="#">Home
                        Textiles</a><a href="#">Kitchenware</a><a href="#">Lamps & Lighting</a><a href="#.html">Office &
                        School Supplies</a><a href="#.html">Pet Products</a>
                </p>
                <p><strong>Phones & Mobile Phones:</strong><a href="#">Landline Phones</a><a href="#">Mobile Phone
                        Accessories</a><a href="#">Smartphones & Mobile Phones</a>
                </p>
                <p><strong>Shoes:</strong><a href="#">Children's Shoes</a><a href="#">Men's Shoes</a><a href="#">Stock
                        Lot Shoes</a> <a href="#.html">Women's Shoes</a>
                </p>
                <p><strong>Sports, Hobbies & Leisure:</strong><a href="#">Beach & Pool Products</a><a href="#">Erotic
                        Products</a><a href="#">Sport Shoes</a> <a href="#.html">Sports
                        Accessories</a><a href="#.html">Diverse</a><a href="#.html">Sports Equipment</a><a
                        href="#.html">Sportswear</a><a href="#.html">Gift Items</a>
                </p>
            </div>
