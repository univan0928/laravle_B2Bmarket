...
<body>
            ...
            <div class="ps-container">
                    ...
                    <div class="menu--product-categories">
                        ...
                        <div class="menu__content">
                            <ul class="menu--dropdown">
                              <li><a href="#.html"><i class="icon-star"></i> Hot Promotions</a>
                              </li>
                              <li class="menu-item-has-children has-mega-menu"><a href="#"><i class="icon-laundry"></i> Consumer Electronic</a><span class="sub-toggle"></span>
                                  <div class="mega-menu">
                              ...
                              <li><a href="#.html"><i class="icon-shirt"></i> Clothing &amp; Apparel</a>
                              </li>
                              <li><a href="#.html"><i class="icon-lampshade"></i> Home, Garden &amp; Kitchen</a>
                              </li>
                              <li><a href="#.html"><i class="icon-heart-pulse"></i> Health &amp; Beauty</a>
                              </li>
                              <li><a href="#.html"><i class="icon-diamond2"></i> Yewelry &amp; Watches</a>
                              </li>
                              <li class="menu-item-has-children has-mega-menu"><a href="#"><i class="icon-desktop"></i> Computer &amp; Technology</a><span class="sub-toggle"></span>
                                  <div class="mega-menu">
                                      <div class="mega-menu__column">
                              ...
                              <li><a href="#.html"><i class="icon-baby-bottle"></i> Babies &amp; Moms</a>
                              </li>
                              <li><a href="#.html"><i class="icon-baseball"></i> Sport &amp; Outdoor</a>
                              </li>
                              <li><a href="#.html"><i class="icon-smartphone"></i> Phones &amp; Accessories</a>
                              </li>
                              <li><a href="#.html"><i class="icon-book2"></i> Books &amp; Office</a>
                              </li>
                              <li><a href="#.html"><i class="icon-car-siren"></i> Cars &amp; Motocycles</a>
                              </li>
                              <li><a href="#.html"><i class="icon-wrench"></i> Home Improments</a>
                              </li>
                              <li><a href="#.html"><i class="icon-tag"></i> Vouchers &amp; Services</a>
                              </li>
                            </ul>
                        </div>
                ...
                <div class="header__right">
                    <div class="header__actions"><a class="header__extra" href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="29" fill="black" class="bi bi-chat-dots" viewBox="0 0 16 16">
                        <path d="M5 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"></path>
                        <path d="m2.165 15.803.02-.004c1.83-.363 2.948-.842 3.468-1.105A9.06 9.06 0 0 0 8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6a10.437 10.437 0 0 1-.524 2.318l-.003.011a10.722 10.722 0 0 1-.244.637c-.079.186.074.394.273.362a21.673 21.673 0 0 0 .693-.125zm.8-3.108a1 1 0 0 0-.287-.801C1.618 10.83 1 9.468 1 8c0-3.192 3.004-6 7-6s7 2.808 7 6c0 3.193-3.004 6-7 6a8.06 8.06 0 0 1-2.088-.272 1 1 0 0 0-.711.074c-.387.196-1.24.57-2.634.893a10.97 10.97 0 0 0 .398-2z"></path>
                      </svg>
                      <span><i>0</i></span></a><a class="header__extra" href="#"><i class="icon-heart"></i><span><i>0</i></span></a>
                            ...
                            <div class="mega-menu">
                                <div class="mega-menu__column">
                                    ...
                                    <ul class="mega-menu__list">
                                        ...
                                        <li><a href="liquidation-deals.html">Shop Carousel</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mega-menu__column">
    ...
    <header class="header header--mobile" data-sticky="true">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left"><a class="ps-logo" href="index.html"><img src="img/brandoe.png" alt="" /></a></div>
            <div class="navigation__right">
    ...
    <footer class="ps-footer">
      <div class="ps-container">
          <div class="ps-footer__widgets">
              <aside class="widget widget_footer widget_contact-us">
                  ...
                  <div class="widget_content">
                      ...
                      <p class="mt-10">BrandedStocklots.com is the largest <br/ >
                       ...
                       With sellers from 90 countries, we offer <br /> a wide range of high quality products <br /> that can uplift your sales.</p>
              ...
              <aside class="widget widget_footer">
                  ...
                  <ul class="ps-list--link">
                      ...
                      <li><a href="shipping.html">Stocklots</a></li>
                      <li><a href="return.html">Liquidation Deals</a></li>
                  </ul>
              </aside>
              <aside class="widget widget_footer">
                  ...
                  <ul class="ps-list--link">
                      ...
                      <li><a href="affilate.html">Become A Partner</a></li>
              ...
              <aside class="widget widget_footer">
                  ...
                  <ul class="ps-list--link">
                      <li><a href="our-press.html">Branded Blog</a></li>
          ...
          <div class="ps-footer__links">
              <p><strong>Consumer Electrics:</strong><a href="#">Audio Equipment</a><a href="#">Cameras & Photo</a><a href="#">Computer Accessories</a><a href="#">Computer Hardware</a><a href="#">Desktop Computers</a><a href="#">Laptops & Tablets</a><a href="#.html">Printers & Photocopiers</a><a href="#.html">Small Appliances</a><a href="#.html">Video games & consoles</a> <a href="#.html">Multimedia</a> <a href="#.html">Pallets of mixed electronics</a>
              </p>
              <p><strong>Building & Industry:</strong><a href="#">Building & Industrial Machinery</a><a href="#">Building Materials</a><a href="#">Tools</a><a href="#">Redecoration & Renovation products</a><a href="#">Workwear & PPE</a>
              </p>
              <p><strong>Clothing:</strong><a href="#">Baby & Children Clothes</a><a href="#">Bags & Handbags</a><a href="#">Fashion Accessories</a><a href="#">Men's Clothing</a><a href="#">Stocklots Clothing</a><a href="#">Swimwear</a><a href="#">Underwear</a><a href="#.html">Used Clothing</a> <a href="#.html">Women's Clothing</a>
              </p>
              <p><strong>Food & Beverage:</strong><a href="#">Alcohol</a><a href="#">Beverages</a><a href="#">Food Stocks</a><a href="#">Short-dated food</a>
              </p>
              <p><strong>For Children:</strong><a href="#">Nursery Products</a><a href="#">Toys & Games</a>
              </p>
              <p><strong>Health & Beauty:</strong><a href="#">Body Cosmetics</a><a href="#">Cosmetic Accessories</a><a href="#">Facial Cosmetics & Make Up</a><a href="#">Fragrances</a><a href="#">Hair care</a><a href="#">Healthcare Products</a><a href="#">Toiletries</a>
              </p>
              <p><strong>Home, garden & office:</strong><a href="#">Bathware</a><a href="#">Decorations & Seasonal Goods</a><a href="#">Gardening Products</a><a href="#">Household Chemicals</a><a href="#">Home Textiles</a><a href="#">Kitchenware</a><a href="#">Lamps & Lighting</a><a href="#.html">Office & School Supplies</a><a href="#.html">Pet Products</a>
              </p>
              <p><strong>Phones & Mobile Phones:</strong><a href="#">Landline Phones</a><a href="#">Mobile Phone Accessories</a><a href="#">Smartphones & Mobile Phones</a>
              </p>
              <p><strong>Shoes:</strong><a href="#">Children's Shoes</a><a href="#">Men's Shoes</a><a href="#">Stock Lot Shoes</a> <a href="#.html">Women's Shoes</a>
              </p>
              <p><strong>Sports, Hobbies & Leisure:</strong><a href="#">Beach & Pool Products</a><a href="#">Erotic Products</a><a href="#">Sport Shoes</a> <a href="#.html">Sports Accessories</a><a href="#.html">Diverse</a><a href="#.html">Sports Equipment</a><a href="#.html">Sportswear</a><a href="#.html">Gift Items</a>
              </p>
          </div>
          <div class="ps-footer__copyright">
              <p>&copy; 2023 BrandedStocklots.com All Rights Reserved</p>
              <p><span>Payment Methods:</span><a href="#"><img src="img/payment-method/1.jpg" alt="" /></a><a href="#"><img src="img/payment-method/2.jpg" alt="" /></a><a href="#"><img src="img/payment-method/3.jpg" alt="" /></a><a href="#"><img src="img/payment-method/4.jpg" alt="" /></a><a href="#"><img src="img/payment-method/5.jpg" alt="" /></a></p>
          </div>
      </div>
    </footer>
