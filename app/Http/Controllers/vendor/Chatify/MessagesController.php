...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        ->select('users.id', 'users.name', 'users.email', 'mobile_number', 'avatar', 'dark_mode', 'messenger_color', DB::raw('MAX(ch_messages.created_at) max_created_at'))
        ->orderBy('max_created_at', 'desc')
        ->groupBy('users.id', 'users.name', 'users.email', 'mobile_number', 'avatar', 'dark_mode', 'messenger_color')
